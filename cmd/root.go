...
func syncCmd() *cobra.Command {
	return &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			case dbUtils.OutcomeReclassifyHold:
				// TDI-I4F: a classification-semantics drift / unprovable-basis HOLD is
				// deliberately DISTINCT from "unchanged" — surface it, never collapse it
