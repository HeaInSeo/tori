...
따라서 Binding Reading v0.1은 Layer B의 정적 binding 해석 범위를 먼저 고정한 뒤, Layer C의 runtime 의미로 넘어가기 직전의 경계에 둔다.

#### 3.2.1 Binding Reading v0.1
...
이 subsection의 관련 근거 문서 진입점은 `pipeline_binding_docs_index_v0.1.md`에 정리되어 있다.
